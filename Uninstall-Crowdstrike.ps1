#description: Uninstalls Crowdstrike with Uninstall Token.
#execution mode: IndividualWithRestart
#tags: CrowdStrike, Testing
...
.DESCRIPTION
	...
	Downloads CsUninstallTool.exe from $SecureVars.CrowdstrikeUninstaller's path
